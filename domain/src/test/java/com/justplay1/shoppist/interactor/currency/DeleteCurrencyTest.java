...
public class DeleteCurrencyTest {
    ...
    private DeleteCurrency useCase;
    ...
    public void setUp() {
        ...
        useCase = new DeleteCurrency(mockCurrencyRepository, mockThreadExecutor,
    ...
    @Test
    public void testGetCategoriesUseCaseObservableHappyCase() {
        useCase.buildUseCaseObservable();

        verify(mockCurrencyRepository).delete(models);
