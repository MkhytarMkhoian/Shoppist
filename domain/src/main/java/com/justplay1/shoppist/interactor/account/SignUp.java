 ...
 */
public class SignUp extends UseCase<Account> {

    private final AccountRepository mRepository;
    private AuthCredentials mAuthCredentials;

    @Inject
    public SignUp(AccountRepository repository, ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread) {
    ...
    protected Observable<Account> buildUseCaseObservable() {
        return mRepository.singUp(mAuthCredentials);
    }
}
