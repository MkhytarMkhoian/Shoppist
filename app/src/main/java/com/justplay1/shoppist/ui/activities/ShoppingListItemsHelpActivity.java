 ...
 */
public class ShoppingListItemsHelpActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.help_shopping_list_items_activity);
    ...
    private void initializeToolbar() {
        ...
        toolbar.setTitle(R.string.help_shopping_list_items);
