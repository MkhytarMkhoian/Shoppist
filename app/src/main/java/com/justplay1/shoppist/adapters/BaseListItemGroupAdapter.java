 ...
 */
public abstract class BaseListItemGroupAdapter<T extends BaseModel, GVH extends BaseHeaderHolder, CVH extends BaseDraggableSwipeableItemViewHolder>
    ...
    public BaseListItemGroupAdapter(Context context, Cursor cursor, ContentObserver changeObserver) {
            ...
            case SwipeableItemConstants.DRAWABLE_SWIPE_LEFT_BACKGROUND:
                switch (getLeftSwipeActionType()) {
                    case SwipeActionType.MOVE_ITEM:
                        if (getChildItem(groupPosition, childPosition).getStatus() == Status.DONE) {
    ...
    public interface SwipeEventListener<T extends BaseModel> {
