...
//            ListItemViewModel listItem = intent.getParcelableExtra(LIST_ITEM);
//
...
//            bundle.putParcelable(ListViewModel.class.getName(), list);
//            bundle.putParcelable(ListItemViewModel.class.getName(), listItem);
...
//        rv.setInt(R.id.view_toolbar, "setBackgroundColor", AppPreferences.getColorPrimary());
