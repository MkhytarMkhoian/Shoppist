...
import com.justplay1.shoppist.repository.AccountDataRepository;
...
import com.justplay1.shoppist.repository.NotificationDataRepository;
...
public class RepositoryModule {
    ...
    @Provides
    @Singleton
    NotificationRepository provideNotificationRepository(LocalNotificationDataStoreImpl dataStore, NotificationDAODataMapper dataMapper) {
        return new NotificationDataRepository(dataStore, dataMapper);
    }
