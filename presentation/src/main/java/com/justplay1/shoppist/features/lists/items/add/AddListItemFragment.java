...
import com.justplay1.shoppist.shared.widget.spinner.CategorySpinnerView;
import com.justplay1.shoppist.shared.widget.spinner.CurrencySpinnerView;
import com.justplay1.shoppist.shared.widget.spinner.UnitsSpinnerView;
...
public class AddListItemFragment extends BaseAddElementFragment implements AddListItemView {
    ...
    @Bind(R.id.category_spinner_view) CategorySpinnerView categoryList;
    @Bind(R.id.units_spinner_view) UnitsSpinnerView unitList;
    @Bind(R.id.currency_spinner_view) CurrencySpinnerView currencyList;
