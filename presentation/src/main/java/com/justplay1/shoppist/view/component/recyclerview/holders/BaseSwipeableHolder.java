 ...
 */
public abstract class BaseSwipeableHolder extends BaseItemHolder implements SwipeableItemViewHolder {
    ...
    public BaseSwipeableHolder(View itemView) {
        super(itemView);
    }

    public BaseSwipeableHolder(View itemView, ShoppistRecyclerView.OnItemClickListener clickListener) {
